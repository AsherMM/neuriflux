...
const T = {
  fr: {
    ...
    articles: [
      { slug: "vibe-coding-tools-2026", tag: "Code", color: "#00e6be", t: "5 meilleurs outils pour créer une app sans coder en 2026 (testés en conditions réelles)", d: "Lovable, Bolt.new, v0, Base44, Replit — on a testé les 5 grands outils du vibe coding sur de vrais projets. Tarifs réels, limites cachées et notre verdict pour chaque profil.", time: "13", star: false },
