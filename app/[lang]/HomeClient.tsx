...
type HomeArticle = {
  ...
  time: string; star: boolean; updated?: { fr: string; en: string };
};

// ─── Données extraites hors du composant pour éviter les re-renders ────────────
const COMPARATIFS_FR: HomeComparatif[] = [
  {
    slug: "n8n-vs-make-vs-zapier-2026", tag: "Productivité", color: "#ff4a00",
    winner: "Make", winnerScore: 8.9,
  ...
  {
    slug: "runway-vs-kling-vs-pika-2026", tag: "Vidéo IA", color: "#a855f7",
  ...
  {
    slug: "chatgpt-vs-claude-vs-gemini", tag: "Chatbots", color: "#00e6be",
    ...
    isNew: false, isFeat: true, updated: { fr: "avril 2026", en: "April 2026" },
  },
  {
    slug: "midjourney-vs-dalle-vs-stable-diffusion", tag: "Image", color: "#7c3aed",
    ...
    isNew: false, isFeat: false, updated: { fr: "mars 2026", en: "March 2026" },
  },
  {
    slug: "elevenlabs-vs-openai-tts-vs-playht", tag: "Audio", color: "#ef4444",
  ...
  {
    slug: "jasper-vs-copyai-vs-claude", tag: "Rédaction", color: "#f59e0b",
...
const COMPARATIFS_EN: HomeComparatif[] = [
  {
    slug: "n8n-vs-make-vs-zapier-2026", tag: "Productivity", color: "#ff4a00",
    winner: "Make", winnerScore: 8.9,
  ...
  {
    slug: "runway-vs-kling-vs-pika-2026", tag: "AI Video", color: "#a855f7",
    winner: "Runway", winnerScore: 9.0,
  ...
  {
    slug: "jasper-vs-copyai-vs-claude", tag: "Writing", color: "#f59e0b",
    winner: "Claude", winnerScore: 9.0,
    title: "Jasper vs Copy.ai vs Claude 2026",
    subtitle: "20 writing formats tested across SEO, output quality, workflow and value for money.",
    tools: [{ name: "Jasper", score: 7.5 }, { name: "Copy.ai", score: 7.2 }, { name: "Claude", score: 9.0 }],
    isNew: false, isFeat: false, updated: { fr: "avril 2026", en: "April 2026" },
  },
];

const ARTICLES_FR: HomeArticle[] = [
  { slug: "deepseek-review-2026", tag: "Chatbots", color: "#00e6be", t: "DeepSeek : avis 2026, le meilleur ChatGPT gratuit venu de Chine ?", d: "DeepSeek a bouleversé le marché IA. Performances, vie privée, vrais cas d'usage et limites : notre verdict complet.", time: "12", star: true, updated: { fr: "avril 2026", en: "April 2026" } },
  { slug: "grok-review-2026", tag: "Chatbots", color: "#00e6be", t: "Grok : avis 2026, l'IA d'Elon Musk vaut-elle vraiment le coup ?", d: "Grok 3 et 4 promettent données temps réel, contexte géant et ton plus brut. On a tout testé pendant 3 semaines.", time: "13", star: true, updated: { fr: "avril 2026", en: "April 2026" } },
...
const ARTICLES_EN: HomeArticle[] = [
  { slug: "deepseek-review-2026", tag: "Chatbots", color: "#00e6be", t: "DeepSeek Review 2026: the best free ChatGPT alternative?", d: "DeepSeek shook the AI industry. Performance, privacy, real use cases and limits: our complete verdict.", time: "12", star: true, updated: { fr: "avril 2026", en: "April 2026" } },
  { slug: "grok-review-2026", tag: "Chatbots", color: "#00e6be", t: "Grok Review 2026: is Elon Musk's AI actually worth it?", d: "Grok 3 and 4 promise real-time data, giant context and a rougher tone. We tested everything for three weeks.", time: "13", star: true, updated: { fr: "avril 2026", en: "April 2026" } },
...
const T = {
  fr: {
    ...
    clusters: [
      { href: "/comparatifs/chatgpt-vs-claude-vs-gemini", title: "Chatbots IA", sub: "ChatGPT, Claude, Gemini, Grok, DeepSeek et les meilleures alternatives.", count: "Comparatifs et avis clés" },
      { href: "/comparatifs/runway-vs-kling-vs-pika-2026", title: "Vidéo IA", sub: "Runway, Kling, Pika et la nouvelle génération de génération vidéo.", count: "Benchmarks et tests réels" },
      { href: "/comparatifs/midjourney-vs-dalle-vs-stable-diffusion", title: "Image IA", sub: "Midjourney, DALL·E et Stable Diffusion testés sur qualité, prompt et usage réel.", count: "Création visuelle et prompts" },
      { href: "/comparatifs/n8n-vs-make-vs-zapier-2026", title: "Automatisation & productivité", sub: "n8n, Make, Zapier et les outils qui font gagner de vraies heures.", count: "Workflows et gains réels" },
    ],
  ...
  en: {
    ...
    clusters: [
      { href: "/comparatifs/chatgpt-vs-claude-vs-gemini", title: "AI Chatbots", sub: "ChatGPT, Claude, Gemini, Grok, DeepSeek and the strongest alternatives.", count: "Key comparisons and reviews" },
      { href: "/comparatifs/runway-vs-kling-vs-pika-2026", title: "AI Video", sub: "Runway, Kling, Pika and the new generation of AI video tools.", count: "Benchmarks and real tests" },
      { href: "/comparatifs/midjourney-vs-dalle-vs-stable-diffusion", title: "AI Image", sub: "Midjourney, DALL·E and Stable Diffusion tested on quality, prompts and real usage.", count: "Visual creation and prompts" },
      { href: "/comparatifs/n8n-vs-make-vs-zapier-2026", title: "Automation & productivity", sub: "n8n, Make, Zapier and the tools that save real hours.", count: "Workflows and real gains" },
    ],
...
function Counter({ value }: { value: string }) {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(([entry]) => { if (entry.isIntersecting) run(); }, { threshold: 0.2 });
...
function FadeSection({ children, delay = 0 }: { children: React.ReactNode; delay?: number }) {
  ...
  return (
    <div ref={ref} style={{ opacity: visible ? 1 : 0, transform: visible ? "none" : "translateY(20px)", transition: `opacity .55s ${delay}ms ease, transform .55s ${delay}ms ease` }}>
      {children}
    </div>
  );
}
...
export default function HomeClient({ lang }: { lang: Lang }) {
  ...
  // useId peut retourner ":r0:" — on sanitise pour un id HTML valide
  const menuId = `menu-${rawMenuId.replace(/:/g, "")}`;

  // Données stables hors render
  ...
  // WebSite schema avec SearchAction pour la SERP Google
...
/* Nav CTA dynamique au scroll */
.nav-cta{display:flex;align-items:center;gap:.4rem;font-family:var(--d);font-weight:700;font-size:.72rem;padding:6px 14px;border-radius:7px;text-decoration:none;white-space:nowrap;transition:all .18s;color:#080c10;background:var(--cyan);animation:slideDown .3s ease both}
...
h1{font-size:clamp(2.15rem,5.6vw,4.1rem);font-weight:800;line-height:1.04;letter-spacing:-.045em;margin-bottom:1rem;color:var(--text)}
...
/* CTA: primary + secondary — newsletter en dernier par inversion de priorité visuelle */
...
.btn-nl{background:transparent;color:var(--cyan);border:1px solid rgba(0,230,190,.3);font-size:.78rem;padding:10px 18px}
.btn-nl:hover{background:var(--cdim);border-color:var(--cyan)}
...
/* aria-hidden appliqué inline sur la 2e passe */
...
/* Scores tools avec barres et noms */
...
.cluster-card{background:var(--bg2);border:1px solid var(--border);border-radius:14px;padding:1rem 1rem 1.1rem;text-decoration:none;transition:border-color .18s,transform .18s;display:flex;flex-direction:column;gap:.5rem}
...
@media(prefers-reduced-motion:reduce){
  ...
  .cmp,.art,.cluster-card,.btn,.trust-cell{transition:none}
...
`}</style>
      ...
      <nav className={scrolled ? "scrolled" : ""} aria-label={t.menu}>
        ...
        <div style={{ display: "flex", gap: ".65rem", alignItems: "center" }}>
          {/* Nav CTA dynamique — apparaît après 350px de scroll */}
          {showNavCta && (
          ...
          <button
            className="hb"
            onClick={() => { setMenuOpen(prev => !prev); trackEvent("homepage_menu_toggle", { lang, open: !menuOpen }); }}
        ...
        <div className="hero">
          <div className="hero-wrap">
            <FadeSection>
              ...
              {/* extraSeo : sr-only pour ne pas polluer visuellement */}
              <p className="sr-only">{t.hero.extraSeo}</p>
              <div className="hero-proof">
                {/* ⭐ décoratif */}
                <span aria-hidden="true">⭐</span> {t.hero.socialProof}
              </div>
              ...
              <div className="ctas">
                ...
                <Link href={l("/newsletter")} className="btn btn-nl" onClick={() => trackEvent("homepage_cta_click", { location: "hero_newsletter", lang })}>{t.hero.cta3}</Link>
              </div>
          ...
          <div className="ticker-inner">
            <div className="ticker-track">
              ...
              {t.hero.tickerItems.map((item) => (
                <Link key={item.href} href={l(item.href)} className="ticker-item" onClick={() => trackEvent("homepage_ticker_click", { href: item.href, lang })}>
                  {item.label}
                </Link>
              ))}
              {/* 2ème passe — aria-hidden pour éviter doublon lecteur d'écran */}
              {t.hero.tickerItems.map((item) => (
                <Link key={`dup-${item.href}`} href={l(item.href)} className="ticker-item" aria-hidden="true" tabIndex={-1}>
                  {item.label}
                </Link>
              ))}
            </div>
                  ...
                  <div className="cmp-foot">
                    <div className="cmp-meta">
                      <div className="cmp-winner">
                        ...
                        <span className="cmp-wscore" style={{ color: c.color, borderColor: `${c.color}50` }}>{c.winnerScore}/10</span>
                      </div>
                ...
                >
                  ...
                  <div className="art-foot">
                    <div className="art-meta">
                      <span className="art-time"><span aria-hidden="true">⏱</span> {a.time} {t.read}</span>
        ...
        <FadeSection delay={80}>
          <section className="section" aria-labelledby="clusters-heading">
            ...
            <div className="cluster-grid">
              {t.clusters.map((c) => (
                <Link key={c.href} href={l(c.href)} className="cluster-card" onClick={() => trackEvent("homepage_cluster_click", { href: c.href, lang })}>
                  <div className="cluster-title">{c.title}</div>
                  <div className="cluster-sub">{c.sub}</div>
                  <div className="cluster-count">{c.count}</div>
                </Link>
              ))}
            </div>
          </section>
        ...
        <div className="nl-wrap">
          <FadeSection delay={60}>
            <section className="nl-box" aria-labelledby="newsletter-heading">
              ...
              <div className="nl-bullets" aria-label="Avantages">
                {t.nlBullets.map((bullet) => <span key={bullet} className="nl-bullet">✓ {bullet}</span>)}
              </div>
              {/* aria-live pour annoncer succès/erreur aux lecteurs d'écran */}
                  ...
                  <>
                    ...
                    <form className="nl-form" onSubmit={submit} noValidate>
                      <input
                        ...
                        aria-label={lang === "fr" ? "Adresse e-mail" : "Email address"}
                      />
