...
const T = {
  fr: {
    ...
    articles: [
      { slug: "chatgpt-perd-il-face-a-claude-et-gemini-2026", tag: "Chatbots", color: "#00e6be", t: "ChatGPT est-il en train de perdre face à Claude et Gemini ? Ce que disent vraiment les chiffres en 2026", d: "ChatGPT domine encore en 2026, mais Claude progresse sur les utilisateurs avancés et Gemini s’impose avec Google. Chiffres, analyse, dynamiques et verdict complet.", time: "16", star: false },
  ...
  en: {
    ...
    articles: [
      { slug: "chatgpt-perd-il-face-a-claude-et-gemini-2026", tag: "Chatbots", color: "#00e6be", t: "Is ChatGPT Losing to Claude and Gemini? What the Numbers Actually Say in 2026", d: "ChatGPT still leads in 2026, but Claude is gaining with advanced users and Gemini is scaling through Google. Full breakdown, numbers, market dynamics, and verdict.", time: "16", star: false },
