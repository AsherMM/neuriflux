...
const T = {
  fr: {
    ...
    comparatifs: [
      { slug: "n8n-vs-make-vs-zapier-2026", tag: "Productivité", color: "#ff4a00", winner: "Make", winnerScore: 8.9, title: "n8n vs Make vs Zapier 2026 : comparatif complet", subtitle: "On a testé les 3 leaders de l'automatisation sur des projets réels. Tarifs, IA native, facilité d'usage — notre verdict honnête pour choisir le bon outil en 2026.", tools: [{ name: "Zapier", score: 7.8 }, { name: "Make", score: 8.9 }, { name: "n8n", score: 8.4 }], isNew: true, isFeat: true },
    ...
    articles: [
      ...
      { slug: "chatgpt-claude-gemini-2026", tag: "Chatbots", color: "#00e6be", t: "ChatGPT est-il en train de perdre face à Claude et Gemini ? Ce que disent vraiment les chiffres en 2026", d: "ChatGPT reste le plus gros chatbot IA du marché en 2026. Mais Claude gagne du terrain sur les utilisateurs exigeants, pendant que Gemini avance grâce à la distribution de Google. L’analyse complète du basculement.", time: "16", star: false },
  ...
  en: {
    ...
    comparatifs: [
      { slug: "n8n-vs-make-vs-zapier-2026", tag: "Productivity", color: "#ff4a00", winner: "Make", winnerScore: 8.9, title: "n8n vs Make vs Zapier: complete comparison 2026", subtitle: "We tested the 3 automation leaders on real projects. Pricing, native AI, ease of use — our honest verdict to pick the right tool in 2026.", tools: [{ name: "Zapier", score: 7.8 }, { name: "Make", score: 8.9 }, { name: "n8n", score: 8.4 }], isNew: true, isFeat: true },
    ...
    articles: [
      ...
      { slug: "vibe-coding-tools-2026", tag: "Code", color: "#00e6be", t: "5 Best Tools to Build an App Without Coding in 2026 (Real-World Tested)", d: "Lovable, Bolt.new, v0, Base44, Replit — we tested the 5 leading vibe coding tools on real projects. Actual pricing, hidden limits, and our honest verdict for every profile.", time: "16", star: false },
    ],
